...
namespace SpaceAuth {
    ...
    inline constexpr const char* SDK_BUILD_ID = "2026.05.07";
    ...
    struct RuntimeInfo {
        ...
        std::string sdk_update_url;
        bool force_update_enabled = false;
        bool update_available = false;
        bool update_required = false;
        bool sdk_update_required = false;
